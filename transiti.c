...
/* Funzione che restituisce l'area di di sovrapposizione fra i due corpi. `r1' è
 * il raggio della stella, `r2' del pianeta, `d' è la loro distanza proiettata,
 * `x1' e `x2' sono le coordinate, rispettivamente della stella e del pianeta,
 * nel piano del cielo dell'osservatore.
 */
